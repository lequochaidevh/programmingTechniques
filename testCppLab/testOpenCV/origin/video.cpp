...
Mat subtractedImg = Mat::zeros(Size(640,400),CV_8UC3);
Mat frameGlobal;
int main()
{

    Mat bg = imread("/home/devh/workspaceTesting/testOpenCV/origin/cat1.jpg");
    if (bg.empty()) {
    ...
    while (1)
    {
        ...
        if(frame.data)
        {
            ...
            else
            {
                ...
                subtractedImg = Mat::zeros(Size(640,400),CV_8UC3);
            }
