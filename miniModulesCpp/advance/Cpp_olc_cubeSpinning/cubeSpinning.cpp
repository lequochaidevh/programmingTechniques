...
//g++ cubeSpinning.cpp -o cube -std=c++17 -lSDL2 -pthread -lX11 -lGL -lGLX -lpng
...
//                        MultiplyMatrixVector(triRotatedZY.p[0], triRotatedZYX.p[0], matRotX);
//                        MultiplyMatrixVector(triRotatedZY.p[1], triRotatedZYX.p[1], matRotX);
//                        MultiplyMatrixVector(triRotatedZY.p[2], triRotatedZYX.p[2], matRotX);


                        MultiplyMatrixVector(tri.p[0], triRotatedZYX.p[0], matRotX);
                        MultiplyMatrixVector(tri.p[1], triRotatedZYX.p[1], matRotX);
                        MultiplyMatrixVector(tri.p[2], triRotatedZYX.p[2], matRotX);
