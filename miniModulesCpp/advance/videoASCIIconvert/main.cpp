...
int main() {
  string video_path = "/home/devh/workspace/openCVbase/video-to-ascii-cpp-main/vid1.mp4";
  ...
  // 1295 712 : width height real
  // 1632 × 759 : width height in terminal


  height = (width * frame_height / frame_width) * 0.419;
